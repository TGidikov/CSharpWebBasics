...
namespace Andreys.Controllers
{
    public class ProductsController :Controller
    {
        ...
        public HttpResponse Add(ProductAddInputModel inputModel)
        {
            ...
            var productId = this.productsService.Add(inputModel.Name,inputModel.Description,inputModel.ImageUrl,inputModel.Price,inputModel.Category,inputModel.Gender);
